		...
		<view class="proItem mb41 " v-for="item in recData" @click="jumpPage('../construct/index?id='+item.id)">
			<view style="padding: 35rpx 20rpx;">
				<view class="flex between">
					...
					<view class="mglr15" style="flex: 1;">
						<view class="textHiddenTwo" style="width: 100%;height: 90rpx;">
							{{item.title}}
						</view>
						<view class="mt16 between">
							<view style="width: 240rpx; " v-if="item.is_progress == 1">
			...
			<view class="mt39 pt34"
				style="border-top: 1rpx solid #323232;background-color: #4b4b4b;padding: 35rpx 20rpx;border-radius: 0 0 20rpx 20rpx;">
