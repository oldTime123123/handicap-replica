	...
	<view class="normalBg" style="background: #060D1F">
		...
		<view class="pdlr30 mt50">
			<view class="topBox">
				...
				<view class="mt20">
					<nut-image width="100%" height="150" :src="pageData.full_banner" style="border-radius: 20rpx;"  showLoading>
					    <template #loading>
				...
				<view style="width:100% ; " class="mt29 flex col_center pdlr" v-if="!isPre  && pageData.is_progress == 1">
			...
			<view class="botBtn color0" v-if="isPre">
				...
				<view class="btns paid " :style="{background:store.$state.secondColor}"
					@click="showMaskHandle" v-if="canBuy ">
			...
			<div class="wrapper">
				<div class="content ">
					...
					<view class="between">
						...
						<view class="" :style="{background:store.$state.secondColor,color:'#000'}" @click="confirmHandle">
							{{t('all.a_c2')}}
						</view>
					</view>
				</div>
