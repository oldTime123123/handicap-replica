		...
		<view class="pdlr40">
			...
			<view style="margin-top:170rpx">
				...
				<view class="flex   " style="border-bottom: 2rpx solid #ffffff;height: 70rpx;">
					...
					<view class="   flex col_center pdlr50" style="flex: 1;"
				...
				<view class=" center l_inpS mt40 l_inpBg pdlr30 text_white f32"
					:style="{ color: store.$state.contentColor, background: store.$state.thirdColor, border: '1rpx solid ' + store.$state.contentColor }" @click="skip_home">
					{{ t("lo_i.l_o12") }}
				</view>
