			...
			<view style="margin-top:100rpx">
				<view class="flex between l_inpS ">
					<view class="l_inpBg between l_inpS pdlr20 " style="width:160rpx">
						<view class="flex col_center" style="width: 70%;">
							<view class="flex row_center">
								<image :src="`/static/guojia/${curImg}.png`" mode="widthFix" style="width:43rpx;29rpx">
								</image>
							</view>
					...
					<view class=" l_inpS l_inpBg flex col_center pdlr50" style="flex:1"
						...
						<input type="text" :placeholder="t('email.e_a1')" 
							v-model="regisForm.email" v-if="loginStore.$state.chooseTypeInd == 2">
						<nut-icon name="Check" size="20" v-if="phoneRegFlag"
							class="phoneCheck animate__animated animate__fadeIn " :color="store.$state.contentColor"></nut-icon>
					</view>
				</view>
				...
				<view class="flex between l_inpS  mt40">
					<view class=" l_inpS l_inpBg flex col_center pdlr50" style="width:100%">
						<!-- <image src="@/static/themeNum1/country/en.png" mode="widthFix" style="width:43rpx;29rpx"></image> -->
						<input type="text" :placeholder="t('login.l_r2')" 
				...
				<view @click="forgetHandle" class=" center l_inpS mt40  pdlr30 "
					style="margin-top:112rpx;color:#000" :style="{background:store.$state.secondColor}">
					{{t('login.l_f2')}}
				</view>
			</view>
		</view>
