	...
	<view style="background-color: #060D1F;min-height: 100vh;">
		...
		<view class="pdlr30 pt33">
			...
			<view class="flex mt50">
				<view :style="headIndex == 1 ? changeStyle : ''"
					style="background-color: #1E253C; padding: 20rpx; border-radius: 10rpx;  margin-left: 36rpx;font-size: 36rpx;"
					@click="choose(1)">
					{{ t('ttn.t_t56') }}
				</view>
				<view :style="headIndex == 2 ? changeStyle : ''"
					style="background-color: #1E253C; padding: 20rpx; border-radius: 10rpx;   margin-left: 72rpx;font-size: 36rpx;"
					@click="choose(2)">
					{{ t('ttn.t_t57') }}
				</view>
			</view>
			...
			<view v-show="headIndex == 2" class="between tab_head"
				style="color: #fff;background-color: #313951; font-size: 28rpx;justify-content: space-evenly;">
			...
			<view v-show="headIndex == 1" class="between tab_head"
				style="color: #fff;background-color: #313951; font-size: 28rpx;">
			...
			<view class="myOne_sty" style="padding: 0rpx;background-color: #1E253C;">
				<view v-show="headIndex == 2 && rechargeRebateDate?.type !== 0" class=""
					style="font-size: 28rpx;justify-content: space-evenly;">
