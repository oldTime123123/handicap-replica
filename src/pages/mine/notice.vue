		...
		<view class="pdlr35 ">
			...
			<view class="">
				<z-paging class="" ref="paging" v-model="recordsList" @query="getData" width="100%" :fixed="false"
					...
					:loading-more-default-text="t('rec.r_a2')" :loading-more-loading-text="t('record.r_r4')"
					:loading-more-fail-text="t('record.r_r3')">
					<view class="noticeItem" v-for="(item, index) in recordsList" :key="index"
						@click="readHandle(item)">
