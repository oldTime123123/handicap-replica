		...
		<view class="pdlr45 mt70">
			...
			<view class="mt70" >
				...
				<view class="settingInp mt30 flex between">
					<input :type="!showPassword?'text':'password'" :placeholder="t('withdraw.w_w5')" placeholder-class="inpPlaceholder"
						style="height: 100%;width: 100%;color: #333;" v-model="fromData.password">
			...
			<view class="inpBtn center " style="margin-top:180rpx" :style="{background:store.$state.contentColor}" @click="tranferHandle">
				{{t('all.a_c2')}}
			</view>
		</view>
