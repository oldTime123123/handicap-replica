		...
		<view class="pdlr49 pt33">
			...
			<view class="" v-show="flag">
				<view class="Smart" @click="chooseHandle(2)">
					...
					<image style="width: 40rpx;height: 40rpx;" src="../../static/themeNum1/icon/backGo.png" mode=""></image>
				</view>
				<view class="vorne">
					{{t('ttn.t_t16')}}
				</view>
			...
			<view class="mt60">
				<view class="Smart" @click="chooseHandle(1)" style="background: url('../../static/egg/wallet.png') no-repeat;background-size: 100% 100%;">
					<view class="text" >
						 {{t('ttn.t_t13')}}
					</view>
					<image style="width: 40rpx;height: 40rpx;" src="../../static/themeNum1/icon/backGo.png" mode=""></image>
