      ...
      <view class="pdlr30" style="">
        ...
        <view class="topComm2 mt40" v-show="false">
          <view class="commItem" v-for="(item, index) in commList2" @click="juot(item)">
            ...
            <image v-if="index == 3" style="width: 32rpx; height: 32rpx" src="../../static/themeNum1/icon/icon2.png"
              mode=""></image>
          </view>
        </view>
        ...
        <view class="mt69" v-if="true">
            ...
            <view
              ...
              <view class="flex" style="justify-content: space-between;margin-bottom: 32rpx;align-items: center;"
                ...
                <view class="" style="width: 48rpx;">
                  <image style="width: 36rpx;height: 36rpx;" src="../../static/imgs/index/content3-2-1.png" mode=""
          ...
          <view class="between flex-wrap mt39" style="flex-wrap: wrap" v-show="false">
            <view v-for="item in newsList" class="mb29 newsItem flex flex-col"
              ...
              <view class="pdtb25 pdlr32 f24 textHiddenOne" style="background-color: #151527; font-weight: bold">
                {{ item?.des }}
              </view>
            </view>
          </view>
      ...
      <nut-overlay v-model:visible="show" :overlay-style="{ background: 'rgba(0,0,0,0.3)' }"
        ...
        <div class="wrapper flex-col" v-if="maskInd == 0">
          ...
          <view class="center mt20">
            <image src="../../static/themeNum1/icon/closeBtn.png" mode="widthFix" style="width: 80rpx; height: 80rpx"
